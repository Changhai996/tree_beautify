...
def replace_in_file(filepath):
    ...
    # Find where the html string starts and ends
    start_marker = 'html = """'
    ...
    if start_idx == -1 or end_idx == -1:
        print("Could not find html block in server.py")
        return
    ...
    <body>
        ...
        <script>
            ...
            function applyLanguage(lang) {
                ...
                // Dynamic strings like "Default Project"
...
replace_in_file('/Users/duanchanghai/Downloads/tools/TVBOT/server.py')
